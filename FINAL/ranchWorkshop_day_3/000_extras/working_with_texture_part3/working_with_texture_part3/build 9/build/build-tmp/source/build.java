...
public void draw(){
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5f), -(0.5f), 0,   (texW/2)-(map2UV/2), (texH/2)-(map2UV/2) );
			vertex(  (0.5f), -(0.5f), 0,   (texW/2)+(map2UV/2), (texH/2)-(map2UV/2) );
			vertex(  (0.5f),  (0.5f), 0,   (texW/2)+(map2UV/2), (texH/2)+(map2UV/2) );
			vertex( -(0.5f),  (0.5f), 0,   (texW/2)-(map2UV/2), (texH/2)+(map2UV/2) );
		endShape(CLOSE);
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5f), -(0.5f), 0,   (texW/2)-(map3UV/2), (texH/2)-(map3UV/2) );
			vertex(  (0.5f), -(0.5f), 0,   (texW/2)+(map3UV/2), (texH/2)-(map3UV/2) );
			vertex(  (0.5f),  (0.5f), 0,   (texW/2)+(map3UV/2), (texH/2)+(map3UV/2) );
			vertex( -(0.5f),  (0.5f), 0,   (texW/2)-(map3UV/2), (texH/2)+(map3UV/2) );
		endShape(CLOSE);
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5f), -(0.5f), 0,   (texW/2)-(map4UV/2), (texH/2)-(map4UV/2) );
			vertex(  (0.5f), -(0.5f), 0,   (texW/2)+(map4UV/2), (texH/2)-(map4UV/2) );
			vertex(  (0.5f),  (0.5f), 0,   (texW/2)+(map4UV/2), (texH/2)+(map4UV/2) );
			vertex( -(0.5f),  (0.5f), 0,   (texW/2)-(map4UV/2), (texH/2)+(map4UV/2) );
		endShape(CLOSE);
