...
void setup(){
	...
	texOSC = new HOscillator().range(0.0, 1.0).speed(1).freq(1).waveform(H.EASE);
}
...
// pickedUVXY[whichUV].x
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5), -(0.5), 0,   (pickedUVXY[0].x)-(map1UV/2), (pickedUVXY[0].y)-(map1UV/2) );
			vertex(  (0.5), -(0.5), 0,   (pickedUVXY[0].x)+(map1UV/2), (pickedUVXY[0].y)-(map1UV/2) );
			vertex(  (0.5),  (0.5), 0,   (pickedUVXY[0].x)+(map1UV/2), (pickedUVXY[0].y)+(map1UV/2) );
			vertex( -(0.5),  (0.5), 0,   (pickedUVXY[0].x)-(map1UV/2), (pickedUVXY[0].y)+(map1UV/2) );
		endShape(CLOSE);
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5), -(0.5), 0,   (pickedUVXY[1].x)-(map2UV/2), (pickedUVXY[1].y)-(map2UV/2) );
			vertex(  (0.5), -(0.5), 0,   (pickedUVXY[1].x)+(map2UV/2), (pickedUVXY[1].y)-(map2UV/2) );
			vertex(  (0.5),  (0.5), 0,   (pickedUVXY[1].x)+(map2UV/2), (pickedUVXY[1].y)+(map2UV/2) );
			vertex( -(0.5),  (0.5), 0,   (pickedUVXY[1].x)-(map2UV/2), (pickedUVXY[1].y)+(map2UV/2) );
		endShape(CLOSE);
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5), -(0.5), 0,   (pickedUVXY[2].x)-(map3UV/2), (pickedUVXY[2].y)-(map3UV/2) );
			vertex(  (0.5), -(0.5), 0,   (pickedUVXY[2].x)+(map3UV/2), (pickedUVXY[2].y)-(map3UV/2) );
			vertex(  (0.5),  (0.5), 0,   (pickedUVXY[2].x)+(map3UV/2), (pickedUVXY[2].y)+(map3UV/2) );
			vertex( -(0.5),  (0.5), 0,   (pickedUVXY[2].x)-(map3UV/2), (pickedUVXY[2].y)+(map3UV/2) );
		endShape(CLOSE);
	...
	pushMatrix();
		...
		beginShape(QUADS);
			texture( texLoaded[0] );
			vertex( -(0.5), -(0.5), 0,   (pickedUVXY[3].x)-(map4UV/2), (pickedUVXY[3].y)-(map4UV/2) );
			vertex(  (0.5), -(0.5), 0,   (pickedUVXY[3].x)+(map4UV/2), (pickedUVXY[3].y)-(map4UV/2) );
			vertex(  (0.5),  (0.5), 0,   (pickedUVXY[3].x)+(map4UV/2), (pickedUVXY[3].y)+(map4UV/2) );
			vertex( -(0.5),  (0.5), 0,   (pickedUVXY[3].x)-(map4UV/2), (pickedUVXY[3].y)+(map4UV/2) );
		endShape(CLOSE);
